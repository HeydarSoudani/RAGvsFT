...
class CostomizedGenericDataLoader:
    def __init__(self,
    ...
    def load_corpus_queries(self) -> Tuple[Dict[str, Dict[str, str]], Dict[str, str]]:
    ...
    def load_qrels(self, split="test") -> Dict[str, Dict[str, int]]:
